...
const INTERNAL = new Map([
  ...
  ["EVESTACK_PROBE_TELEGRAM_USER_ID", "the caller allow-listed by ci.yml for the no-dispatch inbound probe"],
...
const NON_JS_CONSUMER = new Map([
  [
    ...
    "docker-compose.yml: image: ${EVESTACK_DASHBOARD_IMAGE:-ghcr.io/sammytourani/evestack-dashboard:0.4.0}",
  ],
]);
