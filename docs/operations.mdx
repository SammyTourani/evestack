...
Before leaving recurring work unattended, configure
[external liveness checks and incident handling](/docs/alerts#detect-outages-from-outside-the-installation).
The dashboard cannot notify you while its own process is down.
