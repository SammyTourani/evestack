...
You do not have to check any of this yourself. The scaffolder looks first, before it asks you
anything, and says what it found — including which of *not installed*, *installed but the daemon
is not running*, and *running but this user cannot reach the socket* your machine is in, since
those have three different fixes. See [Docker](/docs/local-setup#docker) for what it will
suggest on each platform.
